"""Unit tests for auto_grocer's own cart-scaling and ingredient logic.
...
the free-form ingredient parser. The vendored auto_grocer_mcp library has its
...
from auto_grocer.utility.graphql_cart import (
    _build_search_term,
