...
class TestRedisHealthCheck:
    ...
    def test_redis_health_when_connected(self):
        ...
        # Redis is an optional dependency not shipped with auto_grocer (we use
        # the in-memory cache). Skip when the package isn't installed.
        pytest.importorskip("redis")
        from auto_grocer_mcp.observability.health import _check_redis_health_sync
    ...
    def test_redis_health_when_redis_not_installed(self):
        ...
        with (
            ...
            patch(
                "auto_grocer_mcp.observability.health._check_redis_health_sync"
            ) as mock_check,
        ):
            from auto_grocer_mcp.models.health import ComponentHealth
    ...
    def test_health_ready_with_redis_configured(self):
        ...
        with patch(
            "auto_grocer_mcp.utils.config.get_settings"
