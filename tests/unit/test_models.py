...
def test_store_model_required_fields():
    ...
    from auto_grocer_mcp.models import Store
...
def test_cart_item_calculates_subtotal():
    ...
    from auto_grocer_mcp.models import CartItem
...
def test_error_response_structure():
    ...
    from auto_grocer_mcp.models import ErrorResponse
...
def test_nutrient_info_with_nested_sub_items():
    ...
    from auto_grocer_mcp.models import NutrientInfo
