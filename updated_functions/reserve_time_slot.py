# Synced 2026-06-21 with the working reserve_time_slot from main.py.
...
# Handles HEB's refreshed tiered reservation modal: selects a delivery tier
# (prefers the free "Scheduled" tier) before choosing a date and timeslot.
#
